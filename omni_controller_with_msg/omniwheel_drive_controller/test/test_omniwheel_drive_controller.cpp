...
#include "test_omniwheel_drive_controller.hpp"
...
using omniwheel_drive_controller::NR_CMD_ITFS;
using omniwheel_drive_controller::NR_REF_ITFS;
using omniwheel_drive_controller::NR_STATE_ITFS;
...
TEST_F(OmniwheelDriveControllerTest, when_controller_is_configured_expect_all_parameters_set)
{
  SetUpController();
...
TEST_F(OmniwheelDriveControllerTest, when_controller_is_activated_expect_reference_reset)
{
  SetUpController();
...
TEST_F(OmniwheelDriveControllerTest, when_controller_active_and_update_called_expect_success)
{
  SetUpController();
...
TEST_F(OmniwheelDriveControllerTest, when_active_controller_is_deactivated_expect_success)
{
  SetUpController();
...
TEST_F(OmniwheelDriveControllerTest, when_update_is_called_expect_status_message)
{
  SetUpController();
...
TEST_F(OmniwheelDriveControllerTest, when_reference_msg_is_too_old_expect_unset_reference)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OmniwheelDriveControllerTest, when_message_has_valid_timestamp_expect_reference_set)
{
  SetUpController();
